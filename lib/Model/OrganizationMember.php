...
class OrganizationMember implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OrganizationMember';
     ...
     * Sets id
     *
     * @param string $id `OrganizationMember` row id.
     *
     * @return self
     */
     ...
     * Sets user
     *
     * @param array<string,mixed>|null $user Embedded user-profile fields (id, email, name, profilePhoto, ...).
     *
     * @return self
     */
