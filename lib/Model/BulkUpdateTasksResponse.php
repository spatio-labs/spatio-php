...
/**
 * BulkUpdateTasksResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class BulkUpdateTasksResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BulkUpdateTasksResponse';
     ...
     * Gets tasks
     *
     * @return \SpatioClient\Model\Task[]
     */
     ...
     * Sets tasks
     *
     * @param \SpatioClient\Model\Task[] $tasks tasks
     *
     * @return self
     */
