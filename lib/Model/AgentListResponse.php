...
/**
 * AgentListResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class AgentListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AgentListResponse';
    ...
    protected static $openAPITypes = [
        'agents' => '\SpatioClient\Model\Agent[]',
        'has_more' => 'bool',
        'total' => 'int',
        'total_count' => 'int'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['agents'] === null && !$this->isNullableSetToNull('agents')) {
            $invalidProperties[] = "'agents' is required";
        }
     ...
     * Gets agents
     *
     * @return \SpatioClient\Model\Agent[]|null
     */
     ...
     * Sets agents
     *
     * @param \SpatioClient\Model\Agent[]|null $agents agents
     *
     * @return self
     */
