 ...
 */
class SlideList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SlideList';
    ...
    protected static $openAPITypes = [
        'slides' => '\SpatioClient\Model\Slide[]',
        'total' => 'int'
    ];
    ...
    {
        $this->setIfExists('slides', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['slides'] === null) {
            $invalidProperties[] = "'slides' can't be null";
        }
     ...
     * Gets slides
     *
     * @return \SpatioClient\Model\Slide[]
     */
     ...
     * Sets slides
     *
     * @param \SpatioClient\Model\Slide[] $slides slides
     *
     * @return self
     */
    ...
    {
        if (is_null($slides)) {
            throw new \InvalidArgumentException('non-nullable slides cannot be null');
        }
