...
class DownloadFileResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'signed_url' => 'string',
        'file' => '\SpatioClient\Model\SpatioFile'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['signed_url'] === null) {
            $invalidProperties[] = "'signed_url' can't be null";
        }
     ...
     * Sets signed_url
     *
     * @param string $signed_url Pre-signed direct-download URL pointing at the backing storage (R2, Drive, etc.). Time-limited per provider. Clients follow the URL — the platform does not proxy bytes.
     *
     * @return self
     */
     ...
     * Gets file
     *
     * @return \SpatioClient\Model\SpatioFile
     */
     ...
     * Sets file
     *
     * @param \SpatioClient\Model\SpatioFile $file file
     *
     * @return self
     */
