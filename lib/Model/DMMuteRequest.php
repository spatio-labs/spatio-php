...
/**
 * DMMuteRequest Class Doc Comment
 *
 * @category Class
 * @description Mute either until a specific time (&#x60;untilSeconds&#x60;, Unix epoch) or forever (&#x60;forever: true&#x60;). At least one must be set.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DMMuteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DMMuteRequest';
    ...
    {
        $this->setIfExists('until_seconds', $data ?? [], null);
    ...
    {
        return $this->container['until_seconds'];
    }

    /**
     * Sets until_seconds
     *
     * @param int|null $until_seconds until_seconds
     *
     * @return self
     */
    public function setUntilSeconds($until_seconds)
    {
        if (is_null($until_seconds)) {
            throw new \InvalidArgumentException('non-nullable until_seconds cannot be null');
        }
        $this->container['until_seconds'] = $until_seconds;
     ...
     * Sets forever
     *
     * @param bool|null $forever forever
     *
     * @return self
     */
