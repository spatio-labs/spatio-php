 ...
 *
 * @category Class
 * @description A unified-feed item. Source-aware — &#x60;category&#x60; indicates which upstream platform (mail, dm, channel, mention, system) produced it; &#x60;id&#x60; is the inbox-item id (not the underlying message id).
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class InboxItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_mention', $data ?? [], null);
    ...
    {
        return $this->container['is_mention'];
    }

    /**
     * Sets is_mention
     *
     * @param bool|null $is_mention is_mention
     *
     * @return self
     */
    public function setIsMention($is_mention)
    {
        if (is_null($is_mention)) {
            throw new \InvalidArgumentException('non-nullable is_mention cannot be null');
        }
        $this->container['is_mention'] = $is_mention;
