...
/**
 * ExecuteChatActionRequest Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class ExecuteChatActionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ExecuteChatActionRequest';
     ...
     * Sets params
     *
     * @param mixed|null $params Action-specific parameters. Free-form because the shape depends on `action_id`. See `GET /actions` for the per-id contract.
     *
     * @return self
     */
