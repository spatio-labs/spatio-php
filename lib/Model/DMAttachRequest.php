...
/**
 * DMAttachRequest Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class DMAttachRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DMAttachRequest';
     ...
     * Sets kind
     *
     * @param string $kind Attachment kind (`image`, `file`, `audio`, `video`, etc.).
     *
     * @return self
     */
