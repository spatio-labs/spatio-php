...
/**
 * CreateRecordRequest Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class CreateRecordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateRecordRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('record_type_id', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['record_type_id'] === null) {
            $invalidProperties[] = "'record_type_id' can't be null";
        }
     ...
     * Sets record_type_id
     *
     * @param string $record_type_id record_type_id
     *
     * @return self
     */
    public function setRecordTypeId($record_type_id)
    {
        if (is_null($record_type_id)) {
            throw new \InvalidArgumentException('non-nullable record_type_id cannot be null');
        }
