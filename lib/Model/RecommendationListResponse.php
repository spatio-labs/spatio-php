...
/**
 * RecommendationListResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class RecommendationListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RecommendationListResponse';
    ...
    protected static $openAPITypes = [
        'items' => '\SpatioClient\Model\Recommendation[]'
    ];
     ...
     * Gets items
     *
     * @return \SpatioClient\Model\Recommendation[]
     */
     ...
     * Sets items
     *
     * @param \SpatioClient\Model\Recommendation[] $items items
     *
     * @return self
     */
