...
/**
 * ContactCategoryListResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class ContactCategoryListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ContactCategoryListResponse';
    ...
    protected static $openAPITypes = [
        'categories' => '\SpatioClient\Model\ContactCategory[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['categories'] === null && !$this->isNullableSetToNull('categories')) {
            $invalidProperties[] = "'categories' is required";
        }
     ...
     * Gets categories
     *
     * @return \SpatioClient\Model\ContactCategory[]|null
     */
     ...
     * Sets categories
     *
     * @param \SpatioClient\Model\ContactCategory[]|null $categories categories
     *
     * @return self
     */
