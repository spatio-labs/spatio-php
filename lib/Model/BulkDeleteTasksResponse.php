...
/**
 * BulkDeleteTasksResponse Class Doc Comment
 *
 * @category Class
 * @description Partial-success envelope. &#x60;success&#x60; is &#x60;true&#x60; only when zero failures; &#x60;affectedCount&#x60; is the deleted count; &#x60;taskIds&#x60; lists the ids that succeeded; &#x60;failed&#x60; lists per-id errors.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BulkDeleteTasksResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BulkDeleteTasksResponse';
    ...
    protected static $openAPITypes = [
        ...
        'affected_count' => 'int',
        'task_ids' => 'string[]',
        'failed' => '\SpatioClient\Model\BulkDeleteTasksResponseFailedInner[]'
    ];
    ...
    protected static $setters = [
        'success' => 'setSuccess',
        'affected_count' => 'setAffectedCount',
        'task_ids' => 'setTaskIds',
        'failed' => 'setFailed'
    ];
    ...
    protected static $getters = [
        'success' => 'getSuccess',
        'affected_count' => 'getAffectedCount',
        'task_ids' => 'getTaskIds',
        'failed' => 'getFailed'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('affected_count', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['affected_count'] === null) {
            $invalidProperties[] = "'affected_count' can't be null";
        }
    ...
    {
        return $this->container['affected_count'];
    }

    /**
     * Sets affected_count
     *
     * @param int $affected_count affected_count
     *
     * @return self
     */
    public function setAffectedCount($affected_count)
    {
        if (is_null($affected_count)) {
            throw new \InvalidArgumentException('non-nullable affected_count cannot be null');
        }
        $this->container['affected_count'] = $affected_count;
     ...
     * Gets failed
     *
     * @return \SpatioClient\Model\BulkDeleteTasksResponseFailedInner[]
     */
     ...
     * Sets failed
     *
     * @param \SpatioClient\Model\BulkDeleteTasksResponseFailedInner[] $failed failed
     *
     * @return self
     */
