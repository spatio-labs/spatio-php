...
/**
 * BulkMarkReadRequest Class Doc Comment
 *
 * @category Class
 * @description Bulk shorthand for setting read state on many messages at once. &#x60;messageIds&#x60; accepts an array; the production handler also accepts a bare string for renderer-compat but the spec models the array shape only. &#x60;read&#x60; defaults to &#x60;true&#x60; when omitted.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BulkMarkReadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BulkMarkReadRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('read', $data ?? [], true);
    }
