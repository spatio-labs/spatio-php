...
class CreateNoteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateNoteRequest';
     ...
     * Sets account_id
     *
     * @param string|null $account_id Optional override for the target connected account. May also be passed as a `?accountId=` query param.
     *
     * @return self
     */
     ...
     * Sets provider
     *
     * @param string|null $provider Optional provider id (alternative to `accountId` when only one account exists for the provider). May also be passed as a `?provider=` query param.
     *
     * @return self
     */
