...
/**
 * BulkDeleteEmailsRequest Class Doc Comment
 *
 * @category Class
 * @description Soft-deletes by default (moves to provider trash). Set &#x60;permanent: true&#x60; to hard-delete.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BulkDeleteEmailsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BulkDeleteEmailsRequest';
