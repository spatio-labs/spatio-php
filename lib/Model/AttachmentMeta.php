...
/**
 * AttachmentMeta Class Doc Comment
 *
 * @category Class
 * @description Attachment metadata; binary fetched via the attachment endpoint.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AttachmentMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AttachmentMeta';
