...
/**
 * BulkMarkReadResponse Class Doc Comment
 *
 * @category Class
 * @description Partial-success envelope for &#x60;bulkMarkEmailsRead&#x60;. &#x60;updated&#x60; is a count (not an array — distinct from archive/delete which return the actual id list). The failed-row shape uses &#x60;id&#x60; (also distinct — renderer-compat legacy).
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BulkMarkReadResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BulkMarkReadResponse';
    ...
    protected static $openAPITypes = [
        'updated' => 'int',
        'failed' => '\SpatioClient\Model\BulkMarkReadResponseFailedInner[]'
    ];
     ...
     * Sets updated
     *
     * @param int $updated Number of messages successfully marked.
     *
     * @return self
     */
     ...
     * Gets failed
     *
     * @return \SpatioClient\Model\BulkMarkReadResponseFailedInner[]
     */
     ...
     * Sets failed
     *
     * @param \SpatioClient\Model\BulkMarkReadResponseFailedInner[] $failed failed
     *
     * @return self
     */
