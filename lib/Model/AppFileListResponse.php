...
/**
 * AppFileListResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class AppFileListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AppFileListResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['files'] === null && !$this->isNullableSetToNull('files')) {
            $invalidProperties[] = "'files' is required";
        }
