...
/**
 * CoreActionListResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class CoreActionListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CoreActionListResponse';
    ...
    protected static $openAPITypes = [
        'actions' => '\SpatioClient\Model\CoreAction[]',
        'total' => 'int'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['actions'] === null && !$this->isNullableSetToNull('actions')) {
            $invalidProperties[] = "'actions' is required";
        }
     ...
     * Gets actions
     *
     * @return \SpatioClient\Model\CoreAction[]|null
     */
     ...
     * Sets actions
     *
     * @param \SpatioClient\Model\CoreAction[]|null $actions actions
     *
     * @return self
     */
