...
/**
 * GetChatUserResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class GetChatUserResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetChatUserResponse';
    ...
    protected static $openAPITypes = [
        'user' => '\SpatioClient\Model\ChatUser',
        'provider' => 'string'
    ];
     ...
     * Gets user
     *
     * @return \SpatioClient\Model\ChatUser
     */
     ...
     * Sets user
     *
     * @param \SpatioClient\Model\ChatUser $user user
     *
     * @return self
     */
