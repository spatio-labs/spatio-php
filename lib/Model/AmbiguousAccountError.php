...
/**
 * AmbiguousAccountError Class Doc Comment
 *
 * @category Class
 * @description Returned when the caller&#39;s request matches more than one connected account and no &#x60;accountId&#x60; query param disambiguates which one to target. The &#x60;accounts&#x60; array enumerates the candidates so the client can prompt the user to pick.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AmbiguousAccountError implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AmbiguousAccountError';
    ...
    protected static $openAPITypes = [
        'error' => 'string',
        'code' => 'string',
        'accounts' => '\SpatioClient\Model\AccountChoice[]'
    ];
     ...
     * Gets accounts
     *
     * @return \SpatioClient\Model\AccountChoice[]|null
     */
     ...
     * Sets accounts
     *
     * @param \SpatioClient\Model\AccountChoice[]|null $accounts accounts
     *
     * @return self
     */
