...
/**
 * EmailFolderListResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class EmailFolderListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EmailFolderListResponse';
    ...
    protected static $openAPITypes = [
        'folders' => '\SpatioClient\Model\EmailFolder[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['folders'] === null && !$this->isNullableSetToNull('folders')) {
            $invalidProperties[] = "'folders' is required";
        }
     ...
     * Gets folders
     *
     * @return \SpatioClient\Model\EmailFolder[]|null
     */
     ...
     * Sets folders
     *
     * @param \SpatioClient\Model\EmailFolder[]|null $folders folders
     *
     * @return self
     */
