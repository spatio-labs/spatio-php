 ...
 *
 * @category Class
 * @description A single cell. &#x60;value&#x60; is the JSON-serializable cell contents; interpretation is provider-specific.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Cell implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets value
     *
     * @param mixed|null $value Any JSON value (string, number, boolean, null, object).
     *
     * @return self
     */
