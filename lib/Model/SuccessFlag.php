...
/**
 * SuccessFlag Class Doc Comment
 *
 * @category Class
 * @description Lightweight ack returned by mutations that have no other body (&#x60;DELETE /v1/notes/:id&#x60;, block move, etc.).
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SuccessFlag implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SuccessFlag';
