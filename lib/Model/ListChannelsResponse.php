 ...
 */
class ListChannelsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ListChannelsResponse';
    ...
    protected static $openAPITypes = [
        'channels' => '\SpatioClient\Model\Channel[]',
        'total' => 'int',
        'next_cursor' => 'string',
        'provider' => 'string'
    ];
     ...
     * Gets channels
     *
     * @return \SpatioClient\Model\Channel[]|null
     */
     ...
     * Sets channels
     *
     * @param \SpatioClient\Model\Channel[]|null $channels `null` when no results (Go nil-slice serialization).
     *
     * @return self
     */
