...
/**
 * InboxListResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class InboxListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'InboxListResponse';
    ...
    protected static $openAPITypes = [
        'items' => '\SpatioClient\Model\InboxItem[]',
        'total_count' => 'int',
        'has_more' => 'bool'
    ];
     ...
     * Gets items
     *
     * @return \SpatioClient\Model\InboxItem[]
     */
     ...
     * Sets items
     *
     * @param \SpatioClient\Model\InboxItem[] $items items
     *
     * @return self
     */
