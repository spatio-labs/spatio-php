...
/**
 * UpdateRowRequest Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class UpdateRowRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateRowRequest';
     ...
     * Sets cells
     *
     * @param array<string,mixed> $cells Sparse update. Keys present in the map overwrite that column; keys absent are preserved.
     *
     * @return self
     */
