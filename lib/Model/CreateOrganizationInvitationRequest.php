...
/**
 * CreateOrganizationInvitationRequest Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class CreateOrganizationInvitationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateOrganizationInvitationRequest';
     ...
     * Sets workspace_id
     *
     * @param string|null $workspace_id Optional — the invitee will also be added to this workspace on accept. Defaults to the org's default workspace.
     *
     * @return self
     */
