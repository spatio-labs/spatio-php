...
/**
 * CallRecordingListResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class CallRecordingListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CallRecordingListResponse';
    ...
    protected static $openAPITypes = [
        'recordings' => '\SpatioClient\Model\CallRecording[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['recordings'] === null && !$this->isNullableSetToNull('recordings')) {
            $invalidProperties[] = "'recordings' is required";
        }
     ...
     * Gets recordings
     *
     * @return \SpatioClient\Model\CallRecording[]|null
     */
     ...
     * Sets recordings
     *
     * @param \SpatioClient\Model\CallRecording[]|null $recordings recordings
     *
     * @return self
     */
    public function setRecordings($recordings)
    {
        if (is_null($recordings)) {
            array_push($this->openAPINullablesSetToNull, 'recordings');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('recordings', $nullablesSetToNull);
            if ($index !== FALSE) {
