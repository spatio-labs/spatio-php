...
/**
 * SignInMethodsProvidersInner Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class SignInMethodsProvidersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SignInMethods_providers_inner';
     ...
     * Sets provider
     *
     * @param string $provider OAuth IdP: `GOOGLE`, `GITHUB`, etc.
     *
     * @return self
     */
