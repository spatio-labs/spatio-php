 ...
 *
 * @category Class
 * @description The full token (prefix + secret) is returned ONLY on creation. Store it now or you&#39;ll have to recreate; the API never returns the secret again.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CreatePATResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'token' => 'string',
        'pat' => '\SpatioClient\Model\PersonalAccessToken'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('pat', $data ?? [], null);
    }
     ...
     * Gets pat
     *
     * @return \SpatioClient\Model\PersonalAccessToken|null
     */
    public function getPat()
    {
        return $this->container['pat'];
    }

    /**
     * Sets pat
     *
     * @param \SpatioClient\Model\PersonalAccessToken|null $pat pat
     *
     * @return self
     */
    ...
    {
        if (is_null($pat)) {
            throw new \InvalidArgumentException('non-nullable pat cannot be null');
        }
        $this->container['pat'] = $pat;
