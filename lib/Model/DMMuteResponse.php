...
/**
 * DMMuteResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class DMMuteResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DMMuteResponse';
    ...
    {
        $this->setIfExists('muted_until', $data ?? [], null);
    }
     ...
     * Sets muted_until
     *
     * @param int|null $muted_until muted_until
     *
     * @return self
     */
    public function setMutedUntil($muted_until)
    {
        if (is_null($muted_until)) {
            array_push($this->openAPINullablesSetToNull, 'muted_until');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('muted_until', $nullablesSetToNull);
            if ($index !== FALSE) {
