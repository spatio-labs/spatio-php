...
/**
 * SearchFilesResponse Class Doc Comment
 *
 * @category Class
 * @description In-memory substring search across the caller&#39;s files. Provider filtering isn&#39;t standardized across providers, so the platform lists up to ~500 files and filters locally — &#x60;total&#x60; is the pre-truncation count, not the global count.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SearchFilesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SearchFilesResponse';
