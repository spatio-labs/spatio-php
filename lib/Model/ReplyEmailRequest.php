...
/**
 * ReplyEmailRequest Class Doc Comment
 *
 * @category Class
 * @description Reply to a specific email. &#x60;to/cc/bcc&#x60; are optional — the platform falls back to the original sender / recipients when omitted.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ReplyEmailRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ReplyEmailRequest';
