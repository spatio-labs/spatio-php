...
/**
 * AccountChoice Class Doc Comment
 *
 * @category Class
 * @description One of the candidates returned alongside an &#x60;ambiguous_account&#x60; error so the client can prompt the user to pick a target account.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AccountChoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AccountChoice';
