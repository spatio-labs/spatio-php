...
/**
 * MoveBlockRequest Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class MoveBlockRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MoveBlockRequest';
     ...
     * Sets parent_id
     *
     * @param string|null $parent_id New parent block id; omit to keep the current parent.
     *
     * @return self
     */
