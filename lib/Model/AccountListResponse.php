 ...
 *
 * @category Class
 * @description &#x60;GET /v1/accounts&#x60; returns &#x60;{accounts_by_platform, total_accounts}&#x60; on production today. Schema kept open until the consumers migrate to a flat &#x60;accounts&#x60; array.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class AccountListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AccountListResponse';
    ...
    protected static $openAPITypes = [
        'accounts_by_platform' => 'array<string,mixed>',
        'total_accounts' => 'int',
        'accounts' => 'array[]'
    ];
    ...
    protected static $setters = [
        'accounts_by_platform' => 'setAccountsByPlatform',
    ...
    protected static $getters = [
        'accounts_by_platform' => 'getAccountsByPlatform',
    ...
    {
        $this->setIfExists('accounts_by_platform', $data ?? [], null);
        $this->setIfExists('total_accounts', $data ?? [], null);
    ...
    /**
     * Gets accounts_by_platform
     *
     * @return array<string,mixed>|null
     */
    public function getAccountsByPlatform()
    {
        return $this->container['accounts_by_platform'];
    }

    /**
     * Sets accounts_by_platform
     *
     * @param array<string,mixed>|null $accounts_by_platform accounts_by_platform
     *
     * @return self
     */
    public function setAccountsByPlatform($accounts_by_platform)
    {
        if (is_null($accounts_by_platform)) {
            throw new \InvalidArgumentException('non-nullable accounts_by_platform cannot be null');
        }
        $this->container['accounts_by_platform'] = $accounts_by_platform;
     ...
     * Sets total_accounts
     *
     * @param int|null $total_accounts total_accounts
     *
     * @return self
     */
    public function setTotalAccounts($total_accounts)
    {
        if (is_null($total_accounts)) {
            throw new \InvalidArgumentException('non-nullable total_accounts cannot be null');
        }
     ...
     * Sets accounts
     *
     * @param array[]|null $accounts accounts
     *
     * @return self
     */
