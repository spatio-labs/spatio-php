...
/**
 * ListChatUsersResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class ListChatUsersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ListChatUsersResponse';
    ...
    protected static $openAPITypes = [
        'users' => '\SpatioClient\Model\ChatUser[]',
        'total' => 'int',
        'next_cursor' => 'string',
        'provider' => 'string'
    ];
     ...
     * Gets users
     *
     * @return \SpatioClient\Model\ChatUser[]|null
     */
     ...
     * Sets users
     *
     * @param \SpatioClient\Model\ChatUser[]|null $users users
     *
     * @return self
     */
