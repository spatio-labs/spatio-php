...
/**
 * OrganizationMemberInvitedBy Class Doc Comment
 *
 * @category Class
 * @description Inviter info. Returns either a bare user id (&#x60;string&#x60;) on legacy paths, or an object envelope &#x60;{id, email, name, ...}&#x60; on enriched responses. Treat as opaque.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrganizationMemberInvitedBy implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OrganizationMember_invitedBy';
