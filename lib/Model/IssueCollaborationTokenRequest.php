...
/**
 * IssueCollaborationTokenRequest Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class IssueCollaborationTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'issueCollaborationToken_request';
     ...
     * Sets room
     *
     * @param string|null $room Optional `<type>:<id>` room identifier (e.g. `note:abc123`). When set, the JWT only authorizes this single room.
     *
     * @return self
     */
