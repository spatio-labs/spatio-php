...
class AppListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['apps'] === null && !$this->isNullableSetToNull('apps')) {
            $invalidProperties[] = "'apps' is required";
        }
     ...
     * Gets apps
     *
     * @return \SpatioClient\Model\App[]|null
     */
     ...
     * Sets apps
     *
     * @param \SpatioClient\Model\App[]|null $apps apps
     *
     * @return self
     */
    ...
    {
        if (is_null($apps)) {
            array_push($this->openAPINullablesSetToNull, 'apps');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('apps', $nullablesSetToNull);
            if ($index !== FALSE) {
