...
/**
 * ExportPDFRequestRasterizedSlidesInner Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class ExportPDFRequestRasterizedSlidesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ExportPDFRequest_rasterizedSlides_inner';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['png'] === null) {
            $invalidProperties[] = "'png' can't be null";
        }
     ...
     * Sets png
     *
     * @param string $png Base64-encoded PNG.
     *
     * @return self
     */
