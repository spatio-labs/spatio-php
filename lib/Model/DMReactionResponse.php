...
/**
 * DMReactionResponse Class Doc Comment
 *
 * @category Class
 * @description &#x60;reactions&#x60; shape is provider-specific; treat as opaque.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DMReactionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DMReactionResponse';
     ...
     * Sets reactions
     *
     * @param mixed|null $reactions Updated reaction list for the message.
     *
     * @return self
     */
    public function setReactions($reactions)
    {
        if (is_null($reactions)) {
            array_push($this->openAPINullablesSetToNull, 'reactions');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reactions', $nullablesSetToNull);
            if ($index !== FALSE) {
