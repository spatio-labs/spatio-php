...
/**
 * FolderListEnvelope Class Doc Comment
 *
 * @category Class
 * @description Fan-out list response for &#x60;GET /v1/files/folders&#x60;.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FolderListEnvelope implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FolderListEnvelope';
    ...
    protected static $openAPITypes = [
        'items' => '\SpatioClient\Model\Folder[]',
     ...
     * Sets items
     *
     * @param \SpatioClient\Model\Folder[]|null $items items
     *
     * @return self
     */
