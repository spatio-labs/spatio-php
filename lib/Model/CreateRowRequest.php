...
/**
 * CreateRowRequest Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class CreateRowRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateRowRequest';
     ...
     * Sets index
     *
     * @param int|null $index Optional zero-based insert position. Omit to append at the end.
     *
     * @return self
     */
     ...
     * Sets cells
     *
     * @param array<string,mixed> $cells cells
     *
     * @return self
     */
