 ...
 *
 * @category Class
 * @description A spreadsheet row. &#x60;cells&#x60; is a column-name → value map. Values are JSON primitives (string, number, boolean) or null; provider- specific richer types (formula, date) are encoded as strings.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Row implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets index
     *
     * @param int $index Zero-based row position.
     *
     * @return self
     */
