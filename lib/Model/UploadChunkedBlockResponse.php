...
/**
 * UploadChunkedBlockResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class UploadChunkedBlockResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UploadChunkedBlockResponse';
    ...
    protected static $setters = [
        ...
        'blocks_remaining' => 'setBlocksRemaining',
    ...
    protected static $getters = [
        ...
        'blocks_remaining' => 'getBlocksRemaining',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('blocks_remaining', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['blocks_remaining'] === null) {
            $invalidProperties[] = "'blocks_remaining' can't be null";
        }
    ...
    /**
     * Gets blocks_remaining
     *
     * @return int
     */
    public function getBlocksRemaining()
    {
        return $this->container['blocks_remaining'];
    }

    /**
     * Sets blocks_remaining
     *
     * @param int $blocks_remaining blocks_remaining
     *
     * @return self
     */
    public function setBlocksRemaining($blocks_remaining)
    {
        if (is_null($blocks_remaining)) {
            throw new \InvalidArgumentException('non-nullable blocks_remaining cannot be null');
        }
        $this->container['blocks_remaining'] = $blocks_remaining;
     ...
     * Sets progress
     *
     * @param float $progress Percent complete, 0–100.
     *
     * @return self
     */
