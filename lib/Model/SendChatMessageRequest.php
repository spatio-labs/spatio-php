...
/**
 * SendChatMessageRequest Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class SendChatMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SendChatMessageRequest';
     ...
     * Sets channel
     *
     * @param string $channel Channel or DM id (provider-scoped).
     *
     * @return self
     */
     ...
     * Sets blocks
     *
     * @param array<string,mixed>[]|null $blocks Provider-specific rich-message blocks.
     *
     * @return self
     */
