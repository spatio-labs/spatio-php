 ...
 *
 * @category Class
 * @description Stored agent configuration (system prompt + tool selection). User-defined agents and preconfigured agents share this shape.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Agent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'is_preconfigured' => 'setIsPreconfigured',
    ...
    protected static $getters = [
        ...
        'is_preconfigured' => 'getIsPreconfigured',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_preconfigured', $data ?? [], null);
    ...
    /**
     * Gets is_preconfigured
     *
     * @return bool|null
     */
    public function getIsPreconfigured()
    {
        return $this->container['is_preconfigured'];
    }

    /**
     * Sets is_preconfigured
     *
     * @param bool|null $is_preconfigured is_preconfigured
     *
     * @return self
     */
    public function setIsPreconfigured($is_preconfigured)
    {
        if (is_null($is_preconfigured)) {
            throw new \InvalidArgumentException('non-nullable is_preconfigured cannot be null');
        }
        $this->container['is_preconfigured'] = $is_preconfigured;
