 ...
 *
 * @category Class
 * @description List of emails across the selected accounts. &#x60;provider&#x60; is set on single-account calls; on fan-out it carries the value from the first contributing account (legacy behavior — clients should rely on the per-row &#x60;provider&#x60; field instead).
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ListEmailsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'emails' => '\SpatioClient\Model\Email[]',
        'total' => 'int',
     ...
     * Gets emails
     *
     * @return \SpatioClient\Model\Email[]|null
     */
     ...
     * Sets emails
     *
     * @param \SpatioClient\Model\Email[]|null $emails `null` when there are no results (Go nil-slice serialization). Treat as equivalent to an empty array.
     *
     * @return self
     */
