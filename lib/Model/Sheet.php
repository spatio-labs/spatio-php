...
class Sheet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sheet_count', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sheet_count'] === null) {
            $invalidProperties[] = "'sheet_count' can't be null";
        }
        if ($this->container['is_public'] === null) {
            $invalidProperties[] = "'is_public' can't be null";
        }
        if ($this->container['is_read_only'] === null) {
            $invalidProperties[] = "'is_read_only' can't be null";
        }
     ...
     * Sets provider
     *
     * @param string|null $provider Registered provider id (e.g. `native-sheets`).
     *
     * @return self
     */
     ...
     * Sets account_id
     *
     * @param string|null $account_id Connected-account row this sheet belongs to.
     *
     * @return self
     */
     ...
     * Sets owner_user_id
     *
     * @param string|null $owner_user_id User id of the sheet owner; non-native providers leave empty.
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param array<string,mixed>|null $data Free-form provider blob. Treat as opaque.
     *
     * @return self
     */
     ...
     * Sets column_count
     *
     * @param int $column_count column_count
     *
     * @return self
     */
    ...
    {
        return $this->container['sheet_count'];
    }

    /**
     * Sets sheet_count
     *
     * @param int $sheet_count Tab count when the file contains multiple sheets.
     *
     * @return self
     */
    public function setSheetCount($sheet_count)
    {
        if (is_null($sheet_count)) {
            throw new \InvalidArgumentException('non-nullable sheet_count cannot be null');
        }
        $this->container['sheet_count'] = $sheet_count;
