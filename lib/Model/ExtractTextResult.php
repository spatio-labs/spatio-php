 ...
 *
 * @category Class
 * @description Extracted text + structural metadata from a PDF (or other extraction-supported file type). &#x60;pages&#x60; is provider-shaped — treat as an opaque per-page object array. Endpoint returns &#x60;422&#x60; with &#x60;code: extraction_unsupported&#x60; when the underlying file isn&#39;t extractable.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ExtractTextResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets pages
     *
     * @param array<string,mixed>[]|null $pages pages
     *
     * @return self
     */
     ...
     * Sets truncated
     *
     * @param bool|null $truncated `true` when `maxChars` was hit before the end.
     *
     * @return self
     */
