...
/**
 * EnableShareRequest Class Doc Comment
 *
 * @category Class
 * @description Body for &#x60;POST /v1/notes/{id}/share&#x60;. With &#x60;setPassword: false&#x60;, only the public flag is flipped — any existing password is preserved. With &#x60;setPassword: true&#x60;, the supplied &#x60;password&#x60; is applied (an empty string clears it).
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EnableShareRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EnableShareRequest';
    ...
    {
        $this->setIfExists('set_password', $data ?? [], null);
    ...
    {
        return $this->container['set_password'];
    }

    /**
     * Sets set_password
     *
     * @param bool|null $set_password set_password
     *
     * @return self
     */
    public function setSetPassword($set_password)
    {
        if (is_null($set_password)) {
            throw new \InvalidArgumentException('non-nullable set_password cannot be null');
        }
        $this->container['set_password'] = $set_password;
