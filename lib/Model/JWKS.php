 ...
 */
class JWKS implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'JWKS';
     ...
     * Sets keys
     *
     * @param \SpatioClient\Model\JWK[] $keys keys
     *
     * @return self
     */
