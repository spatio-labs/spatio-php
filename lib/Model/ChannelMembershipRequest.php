...
/**
 * ChannelMembershipRequest Class Doc Comment
 *
 * @category Class
 * @description Body for join/leave operations.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ChannelMembershipRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ChannelMembershipRequest';
