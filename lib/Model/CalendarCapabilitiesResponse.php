...
/**
 * CalendarCapabilitiesResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class CalendarCapabilitiesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CalendarCapabilitiesResponse';
     ...
     * Sets capabilities
     *
     * @param array<string,mixed> $capabilities Per-account feature gate. The renderer reads these to enable/ disable form fields (recurrence pickers, attendee inputs, etc.) based on what the underlying provider supports.
     *
     * @return self
     */
