...
/**
 * ConnectedAppsListResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class ConnectedAppsListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ConnectedAppsListResponse';
    ...
    protected static $openAPITypes = [
        'items' => '\SpatioClient\Model\ConnectedAppItem[]'
    ];
     ...
     * Gets items
     *
     * @return \SpatioClient\Model\ConnectedAppItem[]
     */
     ...
     * Sets items
     *
     * @param \SpatioClient\Model\ConnectedAppItem[] $items items
     *
     * @return self
     */
