...
/**
 * CallListResponse Class Doc Comment
 *
 * @category Class
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 ...
 */
class CallListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CallListResponse';
    ...
    protected static $openAPITypes = [
        'calls' => '\SpatioClient\Model\SpatioCall[]',
        'total' => 'int'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['calls'] === null && !$this->isNullableSetToNull('calls')) {
            $invalidProperties[] = "'calls' is required";
        }
     ...
     * Gets calls
     *
     * @return \SpatioClient\Model\SpatioCall[]|null
     */
     ...
     * Sets calls
     *
     * @param \SpatioClient\Model\SpatioCall[]|null $calls calls
     *
     * @return self
     */
    ...
    {
        if (is_null($calls)) {
            array_push($this->openAPINullablesSetToNull, 'calls');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('calls', $nullablesSetToNull);
            if ($index !== FALSE) {
