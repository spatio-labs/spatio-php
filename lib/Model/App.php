 ...
 *
 * @category Class
 * @description Locally-built prototype app rendered in an Electron &lt;webview&gt;. &#x60;projectPath&#x60; is the on-disk root; file ops are scoped to it.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class App implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('project_path', $data ?? [], null);
     ...
     * Sets project_path
     *
     * @param string|null $project_path project_path
     *
     * @return self
     */
    public function setProjectPath($project_path)
    {
        if (is_null($project_path)) {
            throw new \InvalidArgumentException('non-nullable project_path cannot be null');
        }
