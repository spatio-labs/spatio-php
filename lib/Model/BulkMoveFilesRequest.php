...
/**
 * BulkMoveFilesRequest Class Doc Comment
 *
 * @category Class
 * @description Move multiple files to one target folder. &#x60;targetFolderId&#x60; is the canonical name; &#x60;folderId&#x60; is accepted as a renderer-compat alias.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BulkMoveFilesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BulkMoveFilesRequest';
    ...
    protected static $setters = [
        ...
        'target_folder_id' => 'setTargetFolderId',
    ...
    protected static $getters = [
        ...
        'target_folder_id' => 'getTargetFolderId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('target_folder_id', $data ?? [], null);
     ...
     * Sets file_ids
     *
     * @param string[]|null $file_ids file_ids
     *
     * @return self
     */
    ...
    /**
     * Gets target_folder_id
     *
     * @return string|null
     */
    public function getTargetFolderId()
    {
        return $this->container['target_folder_id'];
    }

    /**
     * Sets target_folder_id
     *
     * @param string|null $target_folder_id target_folder_id
     *
     * @return self
     */
    public function setTargetFolderId($target_folder_id)
    {
        if (is_null($target_folder_id)) {
            array_push($this->openAPINullablesSetToNull, 'target_folder_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('target_folder_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['target_folder_id'] = $target_folder_id;
     ...
     * Sets folder_id
     *
     * @param string|null $folder_id Alias for `targetFolderId`.
     *
     * @return self
     */
