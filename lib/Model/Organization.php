...
class Organization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'member_count' => 'int',
        'workspace_count' => 'int',
        'workspaces' => '\SpatioClient\Model\OrganizationWorkspacesInner[]',
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime'
    ];
    ...
    protected static $setters = [
        ...
        'workspace_count' => 'setWorkspaceCount',
    ...
    protected static $getters = [
        ...
        'workspace_count' => 'getWorkspaceCount',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('workspace_count', $data ?? [], null);
     ...
     * Sets role
     *
     * @param string $role The caller's role in this org (`owner`, `admin`, `billing_admin`, `member`).
     *
     * @return self
     */
    ...
    /**
     * Gets workspace_count
     *
     * @return int|null
     */
    public function getWorkspaceCount()
    {
        return $this->container['workspace_count'];
    }

    /**
     * Sets workspace_count
     *
     * @param int|null $workspace_count workspace_count
     *
     * @return self
     */
    public function setWorkspaceCount($workspace_count)
    {
        if (is_null($workspace_count)) {
            throw new \InvalidArgumentException('non-nullable workspace_count cannot be null');
        }
        $this->container['workspace_count'] = $workspace_count;
     ...
     * Gets workspaces
     *
     * @return \SpatioClient\Model\OrganizationWorkspacesInner[]|null
     */
     ...
     * Sets workspaces
     *
     * @param \SpatioClient\Model\OrganizationWorkspacesInner[]|null $workspaces Compact workspace summaries embedded in the org-list response.
     *
     * @return self
     */
