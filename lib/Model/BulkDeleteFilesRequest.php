...
/**
 * BulkDeleteFilesRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class BulkDeleteFilesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BulkDeleteFilesRequest';
     ...
     * Sets account_ids
     *
     * @param string[]|null $account_ids Parallel slice with fileIds — accountIds[i] targets fileIds[i].
     *
     * @return self
     */
