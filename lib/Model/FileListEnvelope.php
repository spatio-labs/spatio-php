...
/**
 * FileListEnvelope Class Doc Comment
 *
 * @category Class
 * @description Fan-out list response for &#x60;GET /v1/files&#x60;.
 * @package  SpatioClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FileListEnvelope implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FileListEnvelope';
    ...
    protected static $openAPITypes = [
        'items' => '\SpatioClient\Model\SpatioFile[]',
     ...
     * Sets items
     *
     * @param \SpatioClient\Model\SpatioFile[]|null $items items
     *
     * @return self
     */
